...
- 禁止出现任何 `font-family`。
- 禁止出现任何 `line-height`。
- 如设计稿有字体要求，仅保留字号、字重、字色等可落地信息。

### 4.1 标签语义约束

- 不使用 `h1`、`h2`、`h3`、`h4`、`h5`、`h6` 来还原设计稿标题。
- 设计稿中的页面标题、副标题、卡片标题、字段标题统一使用 `span` 或 `p`，并通过类名控制视觉层级。
...
<div className="page-header">
  ...
  <p className="page-subtitle">查看并处理当前订单</p>
</div>
```
